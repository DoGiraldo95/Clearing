...
BEGIN
    MERCURY.LIQUIDACIONRT_PKG.LIQUIDACIONRYT_USOS(TO_DATE('29-08-2023', 'DD-MM-YYYY')); --DIA ACTUAL
END;
/

--- QUERY 2.1, EJECUTAR PAQUETE DE LIQUIDACION USOS VISA
BEGIN
    MERCURY.LIQUIDACIONRT_PKG.LIQUIDACIONRYT_USOS_VISA(TO_DATE('29-08-2023', 'DD-MM-YYYY')); --DIA ACTUAL
END;
/

-- QUERY 3, EJECUTAR PAQUETE DE LIQUIDACION RECARGAS Y VENTAS
BEGIN
    MERCURY.LIQUIDACIONRT_PKG.LIQUIDACION_REC(TO_DATE('29-08-2023', 'DD-MM-YYYY')); --DIA ACTUAL
END;
/

--*************************************************************************************
--*****************  Reporte Liquidacion Usos Por Tarifa 2023******************************* DIA ACTUAL
