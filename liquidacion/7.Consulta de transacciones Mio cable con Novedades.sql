...
FROM
    ...
    CASE
      ...
      AND
        ...
        WHEN (TRUNC(CU.CU_DATETIME) BETWEEN
                     ...
                     2400
         WHEN (TRUNC(CU.CU_DATETIME) BETWEEN
                         TO_DATE('23/01/2023', 'dd-mm-yyyy') AND
                         TO_DATE('15/02/2024', 'dd-mm-yyyy')) THEN
                     2700
        ELSE
                     2900
      END
  ...
  WHERE
    ...
    AND UDF.UDF_RECEIVEDATE >=
               TO_DATE('31-01-2024 00:01', 'dd-mm-yyyy hh24:mi')
    AND UDF.UDF_RECEIVEDATE <=
               TO_DATE('16-02-2024 23:59', 'dd-mm-yyyy hh24:mi')
    --paso 2
