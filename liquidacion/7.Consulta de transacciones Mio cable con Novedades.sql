...
,
 ...
 /*AND cu.cu_datetime >=
         ...
         AND UDF.UDF_RECEIVEDATE >= TO_DATE('31-07-2023 00:01', 'dd-mm-yyyy hh24:mi')
         AND UDF.UDF_RECEIVEDATE <= TO_DATE('16-08-2023 23:59', 'dd-mm-yyyy hh24:mi') --paso 2
 ...
 --            AND TO_CHAR(cu.cu_datetime, 'yyyy')<>2023
         AND TRUNC (CU.CU_DATETIME) NOT IN (TO_DATE('31-07-2023', 'dd-mm-yyyy'), TO_DATE('16-08-2023', 'dd-mm-yyyy'))
...
GROUP BY
   FECHA /*, ESTACION, PUENTE , TARIFA*/ /*,PUENTE*/
 --CANTIDAD_USOS,
