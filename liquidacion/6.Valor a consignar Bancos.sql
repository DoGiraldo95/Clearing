...
--************************--
BEGIN
  MERCURY.LIQUIDACIONRT_PKG.VALOR_CONSIGNAR_BANCOS(TO_DATE('24-08-2023', 'DD-MM-YYYY'));
END;
/
...
WHERE
  A.FECHA_LIQ >= TO_DATE('24-08-2023', 'DD-MM-YYYY')
  AND A.FECHA_LIQ <= TO_DATE('24-08-2023', 'DD-MM-YYYY')
